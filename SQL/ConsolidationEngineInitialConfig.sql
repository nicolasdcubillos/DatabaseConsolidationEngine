...
-------------------------------------------------------------------
-- 2. Crear vistas de errores y estado de consolidaci�n
-------------------------------------------------------------------
...
BEGIN
    ...
    -- Habilitar Change Tracking a nivel de BD si no est�
    IF NOT EXISTS (
    ...
    -- Habilitar Change Tracking en la tabla indicada si no est�
    IF NOT EXISTS (
    ...
    -- Obtener versi�n actual de Change Tracking en esta BD
    DECLARE @cur BIGINT;
